...
const practicalExercises = {
  caesar: [
    ...
    },
    {
      ...
      shift: 10,
      correctAnswer: "HELLO",
      explanation: "R(17)→H(7), O(14)→E(4), V(21)→L(11), V(21)→L(11), Y(24)→O(14). Subtract 10 from each position (with wrapping)."
    }
  ],
  vigenere: [
    {
    ...
    },
    {
      ...
      keyword: "DOG",
      correctAnswer: "FOH",
      explanation: "C(2)+D(3)=F(5), A(0)+O(14)=O(14), T(19)+G(6)=Z(25 wraps to Z). Each position uses keyword letter."
    },
    {
      id: 4,
      difficulty: 4,
    ...
    },
    {
      ...
      difficulty: 5,
      type: 'encrypt',
      question: "Encrypt 'SECRET' using Vigenère cipher with keyword 'PASS'",
      plaintext: "SECRET",
      keyword: "PASS",
      correctAnswer: "HSERXG",
      explanation: "S(18)+P(15)=H(7 wraps), E(4)+A(0)=E(4), C(2)+S(18)=U(20)... Keyword repeats: PASSPA."
    }
  ],
  affine: [
    {
  ...
  multiplicative: [
    ...
    },
    {
      ...
      difficulty: 5,
      type: 'encrypt',
      question: "Using multiplicative cipher E(x)=(17x) mod 26, encrypt letter 'G' (x=6)",
      plaintext: "G",
      multiplier: 17,
      correctAnswer: "T",
      explanation: "E(6) = (17×6) mod 26 = 102 mod 26 = 24. Wait: 102 = 3×26 + 24, so position 24 is... let me recalculate. 102 mod 26: 102÷26 = 3 remainder 24, but that's position 24 which is Y not T. Actually 102 mod 26: 102 - 3*26 = 102 - 78 = 24. Position 24 is Y."
    }
  ]
};
